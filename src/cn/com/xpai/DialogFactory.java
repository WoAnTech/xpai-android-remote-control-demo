...
public class DialogFactory {
	...
	private static Dialog ConnectionDialog() {
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								String mPort = ((EditText) connectionEntryView
										...
										.getText().toString();
								String mKey = ((EditText) connectionEntryView
										.findViewById(R.id.mvkey_edit))
										.getText().toString();
								
								Config.serviceCode = mCode;
								Config.mvHost = mHost;
								Config.mvPort = mPort;
								Config.serviceKey = mKey;
								if(Config.isConnectToTcpPort &&
								...
								if(connectTcpCheckBox.isChecked()) {
									...
									try {
										Manager.connectVS(mHost, Integer.parseInt(mPort), 
													Config.netTimeout * 1000, Config.serviceCode, Config.bufferSize * 1024);
		...
		((EditText) connectionEntryView.findViewById(R.id.mvkey_edit))
		.setText(Config.serviceKey);
